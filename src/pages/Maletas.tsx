...
export default function Maletas() {
  ...
  const [maletas, setMaletas] = useState<any[]>([]);
  ...
  return (
    <div className="global-bg text-surface font-body min-h-screen">
      ...
      <main className="pb-32 editorial-gradient min-h-screen max-w-5xl mx-auto px-6 pt-24">
        <div className="mb-10">
          <h2 className="font-headline text-4xl text-surface mb-2">Maletas</h2>
          <p className="text-surface/60 text-sm">Elegância e praticidade para o seu dia a dia profissional.</p>
        </div>
